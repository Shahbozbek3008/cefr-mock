...
const options = (...texts: string[]): Choice[] =>
  texts.map((text, i) => ({ key: String.fromCharCode(65 + i), text }));

const mcq = (section: string, number: number, prompt: string, choices: string[], answer: string, explanation?: string): Question => ({
  id: `${section}-${number}`,
  number,
  kind: 'mcq',
  prompt,
...
const tfng = (section: string, number: number, prompt: string, answer: 'True' | 'False' | 'Not given', explanation?: string): Question => ({
  id: `${section}-${number}`,
  number,
  kind: 'tfng',
  prompt,
...
export const listeningParts: ListeningPart[] = [
  {
    ...
    durationSec: 300,
    questions: [
      mcq('l', 1, 'Where does the woman want to meet?', ['At the café', 'At the station', 'At the library'], 'B', "Ayol \"let's just meet at the station\" deydi."),
      mcq('l', 2, 'What time does the film start?', ['6:15', '6:45', '7:15'], 'C', "Film 6:45 da emas, reklamadan keyin 7:15 da boshlanadi."),
      mcq('l', 3, 'How will the man travel to work tomorrow?', ['By bus', 'By bike', 'By car'], 'A', 'Velosiped ta\'mirda, mashina esa xotinida — shuning uchun avtobus.'),
      mcq('l', 4, 'What does the girl need to buy?', ['A notebook', 'A calculator', 'A dictionary'], 'B', "Qiz \"I've got the notebooks already\" deydi — kerakligi kalkulyator."),
      mcq('l', 5, 'Why is the shop closed?', ['It is a holiday', 'It is being repaired', 'The owner is ill'], 'B'),
      mcq('l', 6, 'What does the man order?', ['Soup', 'A sandwich', 'A salad'], 'C', 'Sho\'rva tugagan, shuning uchun salat buyuradi.'),
      mcq('l', 7, 'Where did the woman leave her keys?', ['In the car', 'On the desk', 'In her bag'], 'A'),
      mcq('l', 8, 'How much does the ticket cost?', ['£12', '£15', '£20'], 'B', "Narx £20, lekin talabalar uchun £5 chegirma bor."),
    ],
  },
  {
    id: 'l2',
    ...
    questions: [
      ...
      gap('l', 10, 'Student fee per year: £', '35', 'Spiker avval "forty-five" deydi, keyin talabalar uchun "ten pounds off" chegirmani qo\'shadi. Distraktor — birinchi aytilgan raqam.'),
  ...
  },
  {
    ...
    questions: [
      ...
      mcq('l', 21, 'Speaker 5 says her training was', ['too short', 'very practical', 'expensive'], 'B', "\"Hands-on\" iborasi amaliy degan ma'noni beradi."),
      mcq('l', 22, 'Speaker 6 thinks the best part of his job is', ['helping people', 'solving problems', 'flexible hours'], 'A'),
    ],
  },
  {
    id: 'l4',
    ...
    durationSec: 420,
    questions: [
      mcq('l', 23, 'The guest first became interested in gardening', ['as a child', 'at university', 'after moving house'], 'A'),
      ...
      mcq('l', 26, 'According to the guest, community gardens', ['are expensive to run', 'bring neighbours together', 'need official permission'], 'B'),
  ...
  },
  {
    ...
    durationSec: 480,
    questions: [
      mcq('l', 31, 'The lecturer says most adults need', ['6 hours of sleep', '7–9 hours of sleep', '10 hours of sleep'], 'B'),
...
export const readingParts: ReadingPart[] = [
  {
    ...
    passage: [
      { label: 'A', text: 'The Community Sports Centre will reopen on Monday after a two-month renovation. Members can now use the new swimming pool, which is open from 6 am until 10 pm every day.' },
      { label: 'B', text: 'Children under twelve must be accompanied by an adult. Lockers are free, but you need to bring your own lock. Towels can be rented at reception.' },
    ],
    questions: [
  ...
  },
  {
    ...
    passage: [
      { label: 'A', text: 'Hi Sam — the meeting has moved to Thursday. Same room, same time. Please bring the budget figures.' },
      { label: 'B', text: 'Parcel delivery: we tried to deliver your package today. It is now waiting at the post office on King Street.' },
  ...
  },
  {
    ...
    passage: [
      { label: 'A', text: 'Since 2020, millions of office workers have discovered the benefits of working from home. Many report saving over an hour a day on commuting.' },
      { label: 'B', text: 'However, managers worry that creativity suffers when teams rarely meet. Some companies now require staff to come in at least three days a week.' },
      { label: 'C', text: 'Researchers suggest that the best model depends on the task: focused work at home, collaboration in the office.' },
    ],
    questions: [
      ...
      mcq('r', 18, 'Researchers believe the best model', ['depends on the task', 'is fully remote', 'is fully in the office'], 'A'),
      ...
      mcq('r', 21, 'The best title for the article is', ['The End of Offices', 'Finding the Right Balance', 'Why Commuting Matters'], 'B'),
    ],
  },
  {
    id: 'r4',
    ...
    passage: [
      { label: 'A', text: 'Over the past decade, beehives have appeared on rooftops, balconies and school grounds in cities around the world.' },
      { label: 'B', text: 'Supporters argue that urban hives help pollinate parks and gardens, while also teaching residents about nature.' },
      {
        label: 'C',
      ...
      { label: 'D', text: 'Not everyone is convinced. Ecologists warn that a sudden rise in managed hives may crowd out wild pollinators.' },
    ],
    questions: [
      tfng('r', 22, 'Urban beehives can only be found on rooftops.', 'False'),
      tfng('r', 23, 'Rooftop hives yield less honey than hives in the countryside.', 'False', 'C paragrafda "city bees often produce more honey" deyilgan — ya\'ni aksincha.'),
  ...
  },
  {
    ...
    passage: [
      { label: 'A', text: 'Psychologists estimate that around forty percent of our daily actions are habits rather than conscious decisions.' },
      { label: 'B', text: 'Every habit follows a loop: a cue, a routine and a reward. Changing the routine while keeping the cue and reward is the most reliable way to break a bad habit.' },
      { label: 'C', text: 'Contrary to popular belief, forming a new habit takes on average sixty-six days, not twenty-one.' },
    ],
    questions: [
      ...
      mcq('r', 35, 'The writer would most likely agree that', ['habits cannot change', 'change takes time', 'rewards are useless'], 'B'),
    ],
  },
];
...
export const writingTasks: WritingTask[] = [
  {
    ...
    label: 'Task 1',
    kind: 'Letter',
    prompt: 'You recently stayed at a hotel and left something in your room. Write a letter to the manager. Describe the item and explain how it can be returned to you.',
    targetWords: 150,
    minWords: 120,
  },
  {
...
export const speakingQuestions: SpeakingQuestion[] = [
  { id: 's1', index: 1, part: '1.1', prompt: 'Where do you live, and what do you like about it?', prepSec: 5, answerSec: 30 },
  { id: 's2', index: 2, part: '1.1', prompt: 'How do you usually spend your weekends?', prepSec: 5, answerSec: 30 },
  { id: 's3', index: 3, part: '1.2', prompt: 'Describe what you can see in the picture. Why do you think people go to places like this?', image: 'shahar bozori', prepSec: 30, answerSec: 60 },
  { id: 's4', index: 4, part: '1.2', prompt: 'Do you prefer shopping in markets or in supermarkets? Why?', image: 'shahar bozori', prepSec: 30, answerSec: 60 },
  { id: 's5', index: 5, part: '1.2', prompt: 'How have shopping habits changed in your country?', image: 'shahar bozori', prepSec: 30, answerSec: 60 },
  { id: 's6', index: 6, part: '2', prompt: 'Describe a skill you learned recently. Say how you learned it, why it was useful and how you felt.', prepSec: 60, answerSec: 120 },
  { id: 's7', index: 7, part: '2', prompt: 'Talk about a person who has influenced your studies. Explain who they are and how they helped you.', prepSec: 60, answerSec: 120 },
  { id: 's8', index: 8, part: '3', prompt: 'Some people say online learning will replace schools. Give arguments for and against this idea.', prepSec: 60, answerSec: 120 },
];
